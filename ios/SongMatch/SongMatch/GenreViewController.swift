...
class GenreViewController: UIViewController, UpdateMoodGenreDelegate {
    ...
    func setUpConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            hiphop.widthAnchor.constraint(equalToConstant: buttonSize),
            hiphop.heightAnchor.constraint(equalToConstant: buttonSize)
        ...
        NSLayoutConstraint.activate([
            ...
            indie.widthAnchor.constraint(equalToConstant: buttonSize),
            indie.heightAnchor.constraint(equalToConstant: buttonSize)
        ...
        NSLayoutConstraint.activate([
            ...
            rock.widthAnchor.constraint(equalToConstant: buttonSize),
            rock.heightAnchor.constraint(equalToConstant: buttonSize)
